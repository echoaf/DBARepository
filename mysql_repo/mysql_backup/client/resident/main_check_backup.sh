...
mysql_restore_build_py="$base_dir/main/backup_script/mysql_restore_build.py"
shell_function_cnf="$base_dir/main/shell_function.cnf"
function_xtraback_cnf="$base_dir/main/full_backup/backupXtrabackup/function_xtraback.cnf"
